...
from tt_ctr_model_v2 import TTFRCTRModelV2
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        print(test_files)
        two_tower_model = TTFRCTRModelV2(train_file_dir=train_files,
        ...
        try:
            ...
            while True:
                ...
                if two_tower_model.mode == "train":
                    if local == 1:
                        gender, client_type = sess.run(
                            [two_tower_model.gender_tensor, two_tower_model.client_type_tensor])
                        print("gender")
                        print(gender)
                        print("client_type")
                        print(client_type)
