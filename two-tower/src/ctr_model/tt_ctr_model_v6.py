...
class TTFRCTRModelV4:
    def __init__(self,
        ...
        if self.mode in ["train", "eval"]:
            ...
            self.consume_level, self.unclick_seq_50size, self.feed_type \
    ...
    def build_train_batch_data(self, train_data_file, batch_size, num_epochs):
        ...
        client_type, dev_carrier, click_seq_50size, gender, age, consume_level, unclick_seq_50size, feed_type = self.read_train_data(
            file_queue)
        ...
        click_seq_50size_batch, gender_batch, age_batch, consume_level_batch, unclick_seq_50size_batch, feed_type_batch = tf.train.batch(
            [click_label, user_id, item_id, class_id, tag_ids, dev_type, dev_brand, dev_brand_type,
             dev_os, dev_net, client_type, dev_carrier, click_seq_50size, gender, age, consume_level,
             unclick_seq_50size, feed_type],
    ...
    def build_model(self):
        ...
        with tf.name_scope("item_tower"):
            item_embed_concat = tf.concat([self.item_id_embed, self.tag_ids_embed, self.class_id_one_hot], axis=-1)
            ...
            #
            self.item_embeding_final = item_layer_3
