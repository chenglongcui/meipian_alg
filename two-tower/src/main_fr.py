                ...
                if is_train:
                    ...
                    if local == 0:
                        ...
                        user_embeddings, item_embeddings, logits = sess.run(
                            [tf.reduce_join(tf.as_string(two_tower_model.user_embedding_final), 1, separator=","),
                             tf.reduce_join(tf.as_string(two_tower_model.item_embeding_final), 1, separator=","),
