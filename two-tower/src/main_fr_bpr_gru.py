...
from two_tower_model_fr_bpr_gru import TwoTowerModelFRBPRGRU
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        two_tower_model = TwoTowerModelFRBPRGRU(train_file_dir=train_file_name,
        ...
        try:
            ...
            while True:
                ...
                if is_train:
                    ...
                    #     [
                    #         two_tower_model.item_embed_output,
