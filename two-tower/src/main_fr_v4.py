...
from two_tower_model_fr_v4 import TwoTowerModelFRV4
...
def main(_):
    ...
    with tf.Session() as sess:
        ...
        two_tower_model = TwoTowerModelFRV4(train_file_dir=train_file_name,
        ...
        try:
            ...
            while True:
                ...
                if two_tower_model.mode == "train":
                    ...
                    # local test
                    # user_ids, target_item_list, target_cate_list, logits = sess.run(
                    #     [
